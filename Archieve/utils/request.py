...
class Request:
	...
	def download_range(self, url, filepath, range_left, range_right, proxy=None, downloaded_size=0):
		...
		with open(filepath, "wb") as fp:
			...
			while True:
				...
				downloaded_size = max(downloaded_size, downloaded)
				print ("\r{0:.2f} MB".format(downloaded_size/(1024*1024)), end="")
